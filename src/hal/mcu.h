 ...
 *
 * \p Системный таймер включает в себя обработчик прерывания от аппаратного
 ...
 * \endcode
 *
 * \p Такой подход позволяет сократить время нахождения в обработчике прерывания
 ...
 *
 * \p Тем не менее, следует избегать долгой реакции, так как это точно приведёт
